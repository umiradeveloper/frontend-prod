...
const ListMonitoringUpdateVendor = () => {
    ...
    const [idApproval, setIdApproval] = useState(true);
    ...
    const getPengajuan = async() => {
        ...
        try {
            ...
            if(data){
			   ...
			   kualifikasi_usaha: (user.vendor.kualifikasi_usaha)?user.vendor.kualifikasi_usaha.kualifikasi:"-",
...
ListMonitoringUpdateVendor.layout = "ContentlayoutVms";
export default ListMonitoringUpdateVendor;
