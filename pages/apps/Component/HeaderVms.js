...
// import { removeFromCart, ThemeChanger } from "@/shared/redux/actions";
import { removeFromCart, ThemeChanger } from "@/shared/redux/actions";
                    ...
                    <div className="header-content-right">
                        ...
                        <Dropdown className="header-element header-profile">
                            ...
                            <Dropdown.Menu className="main-header-dropdown pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end">
                                ...
                                <Dropdown.Item as={Link} href={"/"} className="d-flex"><i className="fe fe-power fs-16 align-middle me-2"></i>Log Out</Dropdown.Item>
                            </Dropdown.Menu>
                        </Dropdown>
                        {/* Right sidebar */}
...
const HeaderVms = connect(mapStateToProps, { ThemeChanger })(HeaderVmsClient)

export default dynamic(() => Promise.resolve(HeaderVms), { ssr: false });
