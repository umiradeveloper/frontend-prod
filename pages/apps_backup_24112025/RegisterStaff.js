...
const LoginRegisterStaff = () => {
    ...
    const register = async () => {
        ...
        setLoader(true);
        try {
            const response = await axios.post(apiUrl+"/auth/register-staff", {nama_perusahaan: dataRegister.nama_perusahaan, email: dataRegister.email, password: dataRegister.password, kode_branch: dataRegister.branch, no_hp: dataRegister.no_hp, kode_role: dataRegister.kode_role}, {
                headers:{
